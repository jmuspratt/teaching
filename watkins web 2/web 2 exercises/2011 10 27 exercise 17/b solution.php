...
for ($year = 1; $year <= 50; $year ++) {
	$total_rounded = round($total, 2);							        // round off the total before outputting to Terminal
	echo ("After $year year(s) I will have $total_rounded dollars.\n"); // Output the year and total (rounded)
	$total = $total * $interest_multiplier; 						   // calculate a new total based on the old total and the multiplier
	}
echo ("\n\n");
