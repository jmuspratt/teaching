...
$tax_as_multiplier = 1 + ($tax / 100); // create something we can multiply by to get. outputs something like 1.08.
$price_after_tax = $price * $tax_as_multiplier;
$price_after_tax = round ($price_after_tax, 2); // bonus round: it's perfectly fine to use a variable on both sides of an assignment operator. Think of it as "updating" the value of the variable. 
