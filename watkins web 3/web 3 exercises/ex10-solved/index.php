...
// Part 2
	...
	$page_exploded = explode("<h3>CERTIFICATE IN FILM</h3>", $page_html);
	
	$after_certificate = $page_exploded[1];
	
	$after_certificate_exploded = explode("<p><b>Please", $after_certificate);
	
	$the_paragraph = $after_certificate_exploded[0];
		
	// Echo that paragraph into your page here: 
	echo "<p>This paragraph is being retrieved from the very end of <a href='http://watkins.edu/academics'>Watkins Academics web page</a><br /></p>";

	echo ("<div style='border:1px dotted gray; padding:20px;'>");
