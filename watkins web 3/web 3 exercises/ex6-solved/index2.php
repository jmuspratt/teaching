...
<body>
	...
	// ↓ Your code here ↓ 
	for ($counter = 10; $counter <= 20; $counter= $counter + 1) {
		$square = $counter * $counter;
		echo ("<p>The square of $counter is $square</p>");
		}
...
// Here's proof that it works: we can access any of the elements at random and they will echo correctly:
	...
	// ↓ Your code here ↓ 
	for ($counter = 0; $counter <= 74; $counter=$counter + 1) {
		$number = 74 - $counter;
	...
	// ↓ Your code here ↓ 
	for ($counter = 0; $counter <= 74; $counter=$counter + 1) {
		echo ("<p>The number $counter has the value $numbers[$counter].</p>");
		}
	// ↑ Your code here ↑
