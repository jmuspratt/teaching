...
<body>
	...
	// First, store some sample info of your own making in an associative array with three elements. The array should be called $post and you should store the post's title, date, and content in it (in fact, use those words as your associative array keys).
